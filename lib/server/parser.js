...
var args = [
  ...
  , help: 'Unique device identifier of the connected physical device or simulator'
  }],
    
  [['--specific-simulator'], {
      defautValue: false
    , dest: 'specificSimulator'
    , action: 'storeTrue'
    , required: false
    , help: '(IOS-only) use simulator with specific UDID, requires --udid argument to be set'
    , nargs: 0
  }],
